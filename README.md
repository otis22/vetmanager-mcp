...
**101 инструмент** по 12 группам сущностей:

| Группа | Инструменты | Кол-во |
|--------|-------------|--------|
| Client | `get_clients`, `get_debtors`, `get_client_by_id`, `create_client`, `update_client`, `delete_client`, `get_client_profile` | 7 |
| Pet | `get_pets`, `get_pet_by_id`, `create_pet`, `update_pet`, `delete_pet`, `get_pet_profile` | 6 |
| Admission | `get_admissions`, `get_admission_by_id`, `create_admission`, `update_admission` | 4 |
...
| Finance | `get_payments`, `get_payment_by_id`, `create_payment`, `get_invoice_documents`, `get_invoice_document_by_id`, `add_invoice_document`, `delete_invoice_document`, `get_closing_of_invoices`, `get_closing_of_invoice_by_id`, `get_cassas`, `get_cassa_by_id`, `get_cassa_closes`, `get_cassa_close_by_id` | 13 |
