...
**87 инструментов** по 12 группам сущностей:

| Группа | Инструменты |
|--------|-------------|
| Client | `get_clients`, `get_client_by_id`, `create_client`, `update_client`, `delete_client` |
| Pet | `get_pets`, `get_pet_by_id`, `create_pet`, `update_pet`, `delete_pet` |
...
| Invoice | `get_invoices`, `get_invoice_by_id`, `create_invoice`, `update_invoice`, `delete_invoice` |
| InvoiceDocument | `get_invoice_documents`, `get_invoice_document_by_id`, `add_invoice_document`, `delete_invoice_document` |
| Good | `get_goods`, `get_good_by_id`, `create_good`, `update_good`, `get_good_groups`, `get_good_group_by_id`, `get_good_sale_params`, `get_good_sale_param_by_id` |
| User | `get_users`, `get_user_by_id`, `update_user`, `get_roles`, `get_role_by_id`, `get_user_positions`, `get_user_position_by_id` |
...
| Warehouse | `get_party_accounts`, `get_party_account_by_id`, `get_party_account_docs`, `get_party_account_doc_by_id`, `get_store_documents`, `get_store_document_by_id`, `get_suppliers`, `get_supplier_by_id`, `create_supplier`, `update_supplier` |
...
| Operations | `get_clinics`, `get_clinic_by_id`, `get_timesheets`, `get_timesheet_by_id`, `create_timesheet`, `get_properties`, `get_anonymous_clients` |
