...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("дата: 31.12.2026", (), ("31.12.2026",), ()),
        ("значение 4852-45-67", ("4852-45-67",), (), (REDACTED_PHONE,)),
        ("значение 9999-99-99", ("9999-99-99",), (), (REDACTED_PHONE,)),
        ("значение 2026-13-01", ("2026-13-01",), (), (REDACTED_PHONE,)),
        ("значение 2026-01-32", ("2026-01-32",), (), (REDACTED_PHONE,)),
        (
            "значение 2026-01-01 25:00:00",
            ("2026-01-01 25",),
            (),
            (REDACTED_PHONE,),
        ),
        ...
        (
            "89991234567 2024-01-01 2026-12-31",
            ("89991234567",),
            (),
            (REDACTED_PHONE,),
        ),
