...
| [Roadmap-archive.md](Roadmap-archive.md) | Append-only история закрытых этапов вне окна. Не редактируется: переоткрытие или позднее закрытие оформляется новым этапом со ссылкой. |
