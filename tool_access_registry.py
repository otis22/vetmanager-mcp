...
TOOL_REQUIRED_SCOPES: dict[str, tuple[str, ...]] = {
    ...
    "delete_client": (SCOPE_RECORDS_DELETE,),
    "delete_timesheet": (SCOPE_SCHEDULE_WRITE,),
    "delete_pet": (SCOPE_RECORDS_DELETE,),
    "report_problem": (),
    ...
    "get_medical_cards_by_date": (SCOPE_MEDICAL_CARDS_READ,),
    ...
    "reject_report_ai_job_candidate": (SCOPE_REPORT_AI_WRITE,),
    ...
    "get_timesheet_types": (SCOPE_REFERENCE_READ,),
    ...
    "update_timesheet": (SCOPE_SCHEDULE_WRITE,),
