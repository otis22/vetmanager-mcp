...
## Этап 210. Дизайн-ревью лендинга и кабинета — `todo`
...
- 210.1 Лендинг, блок для разработчиков: вернуть аффорданс раскрывашки, вынести
  ...
  dev-раскрывашку из FAQ в основной блок. — `todo`
- 210.2 Лендинг, тексты: убрать дублирующую секцию шагов и мета-фразу, починить
  ...
  Bearer-жаргон со страницы регистрации. — `todo`
...
- 210.4 Кабинет, таблицы: предупреждение из ячейки на всю ширину строки,
  ...
  локальное время, размер тач-таргетов. — `todo`
- 210.5 Лендинг на мобильном: липкая панель появляется только после ухода
  hero-кнопки и не перекрывает контент. — `todo`
- 210.6 Проверки, ревью, deploy и production smoke под тестовым аккаунтом. — `todo`
