...
## Этап 274. Второй слой проверки прав fail-open — `in_progress`
...
- 274.1 Замапить недостающие пути на права записи. — `todo`
- 274.2 Сделать слой fail-closed: неизвестный пишущий путь отклоняется. — `todo`
- 274.3 Сторож на полноту карты: каждый путь из инструментов имеет право на
  запись. Показать красным. — `todo`
