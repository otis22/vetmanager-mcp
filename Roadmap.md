...
## Этап 225. Диагноз в медкарте — ссылка, а не текст — `in_progress`
...
- 225.1 Сообщить в Ветменеджер: три пункта — 500 вместо 400 на числовом
  `diagnos`, приём любой строки без валидации, потеря `diagnos_text` при
  создании карты. Текст подготовлен, отправка — решение владельца. — `todo`
