...
## Этап 315. Человек жалуется через агента — `in_progress`

- 315.1 Источник `human`, сохранение и triage без потери очереди. — `in_progress`
- 315.2 Инструкции клиента и безопасный живой вызов. — `todo`
- 315.3 Reviews, выкат и production triage. — `todo`

## Этап 316. Жалоба из кабинета — `todo`

- 316.1 CSRF-защищённая форма и ограничение частоты. — `todo`
