...
## Этап 251. Экспорт большого отчёта не завершается — `todo`
...
- 251.1 Воспроизвести на объёме, близком к отчёту из #38. — `todo`
- 251.2 Найти границу: до какого размера экспорт завершается. — `todo`
- 251.3 Внятный отказ вместо бесконечного «not ready» — с сроком, после
  которого ждать не нужно, и подсказкой сузить выборку. — `todo`

## Этап 252. Задания Report AI зависают в очереди — `todo`
...
- 252.1 Понять, зависает задание у нас или на стороне Vetmanager. — `todo`
- 252.2 Проверить, работает ли обходной путь из playbook до сих пор. — `todo`
