...
## Этап 309. Плейсхолдер уезжает в базу клиники как значение — `in_progress`
...
- 309.1 Плейсхолдер в аргументе перестаёт уезжать молча. — `todo`
- 309.2 Граница между отказом и подстановкой проводится по каналу утечки, а
  не по удобству. — `todo`
