...
## Этап 259. Прямой агрегат счетов по врачу и периоду — `todo`
...
- 259.1 Подтвердить API-поля, статусы и дату для суммы invoice KPI. — `todo`
- 259.2 Спроектировать ограниченный агрегат по врачу/периоду без полной
  выгрузки clinic data в модель. — `todo`
- 259.3 Сравнить стоимость client-side pagination и upstream aggregate API. — `todo`
