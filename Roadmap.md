...
## Этап 289. Включение защиты, которая никогда не работала — `in_progress`
...
- 289.1 Найти остальные защиты, которые сегодня не действуют, и проверить
  ...
  Кандидаты видны по этапу 285 — всё, что читалось из окружения, но не
  доезжало до контейнера. — `todo`
- 289.2 Выкат, который меняет смысл уже выданных учётных данных, обязан нести
  ...
  отказам. Записать это правилом в Core Loop. — `todo`
