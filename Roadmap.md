...
## Этап 243. В событиях трекинга нет пользователя — `in_progress`
...
- 243.4 Подтвердить на живой выкатке: у нового issue `users` больше нуля. — `todo`
...
## Этап 266. Проверка ввода заводит issue в Sentry мимо наших фильтров — `in_progress`
...
- 266.3 Подтвердить на живой выкатке: опечатка в аргументе issue не создаёт,
  отказ апстрима создаёт ровно одно. — `todo`
