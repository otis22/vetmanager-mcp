...
## Этап 306. Механизм известных проблем не видит 99.8% отказов — `in_progress`
...
- 306.5 Выкат и живой замер: `vetmanager_known_issue_lookups_total` впервые
  считает настоящий поток отказов, а не 0.2% от него. Этот знаменатель —
  вход в 305 и в 283.5. — `todo`
