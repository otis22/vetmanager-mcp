...
## Этап 247. Медкарты кешируются 15 минут вместо минуты — `todo`
...
- 247.5 `doRestUpdate` отвечает `201` вместо `200` и возвращает только
  присланные поля — сообщить в Ветменеджер. — `todo`
