...
## Этап 254. Коммит документации перезапускает прод — `todo`
...
- 254.2 Убедиться, что пропуск деплоя не ломает цепочку `workflow_run`
  для следующего коммита с кодом. — `todo`
...
## Этап 257. «Настроить вручную» не говорит, что там выпускают токен — `todo`
...
- 257.1 Переименовать блок и переписать подсказку над ним. — `todo`
- 257.2 Пройти глазами остальные подписи на странице токенов — не осталось ли
  там ещё формулировок, описывающих механику вместо результата. — `todo`

## Этап 258. По умолчанию токен привязывается к IP браузера — `todo`
