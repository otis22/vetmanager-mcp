...
## Этап 256. Четыре этапа без записи в AssumptionLog — `todo`
...
- 256.1 Восстановить допущения 216, 229, 233, 234 и 243 по коммитам и PRD.
  ...
  а пункт был написан по четырём. — `todo`
- 256.2 Что не восстанавливается — отметить явно, а не выдумывать. — `todo`
