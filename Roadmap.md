...
- 237.4 Остаточный обрыв: выкатка `86f286e` 23.08.2026 в 14:29 МСК закрыла
  ...
  о завершении слива в 11:29:42.021. Для сравнения: прошлая выкатка при пяти
  сессиях дала пять событий. Найти, какой поток остаётся незакрытым: не
  standalone GET SSE, соединение в момент установки, или гонка между закрытием
  и остановкой listener. — `todo`
