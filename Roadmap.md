...
## Этап 202. ChatGPT OAuth Analytics default и friendly consent UX — `in_progress`
...
- 202.5 Checks/review/deploy: targeted tests, full
  ...
  Spark-review, Claude Opus review, commit/push/deploy/smoke. — `todo`

## Этап 203. Full patient medical profile with owner and invoices — `in_progress`
