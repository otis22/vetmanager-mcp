...
## Этап 307. Ошибка вызывающего остаётся без ответа, хотя ответ есть — `in_progress`
...
- 307.1 Разделить два эффекта: `ToolInputError` не получает приглашения
  ...
  поток отдельный от потока отказов; замерить до правки. — `todo`
- 307.2 Правила под классы, которые от этого станут достижимы: сохранение
  ...
  в разделе «недостижимо по замыслу». — `todo`
