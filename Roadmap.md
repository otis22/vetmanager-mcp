...
## Этап 273. Интерфейс и отказ не говорят, что даёт группа — `in_progress`
...
- 273.1 Показывать состав группы при выпуске ключа. — `todo`
- 273.2 Подпись: «что помощник сможет видеть и менять». — `todo`
- 273.3 В отказе называть минимально достаточную группу; полный доступ — не
  первым. — `todo`
