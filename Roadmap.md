...
## Этап 316. Жалоба из кабинета — `in_progress`

- 316.1 CSRF-защищённая форма и ограничение частоты. — `in_progress`
- 316.2 Privacy-safe triage, стенд, reviews и выкат. — `todo`
