...
## Этап 261. Обратная связь копится непрочитанной — `in_progress`
...
- 261.3 Обновить known issue 31 под фактическое состояние после этапа 245. — `todo`
  (запись в прод — ждёт решения владельца)
- 261.4 Ответить на отчёт 47 (нет инструмента задач Ветменеджера) решением:
  заводим инструмент, отказываемся или откладываем с причиной. — `todo`
