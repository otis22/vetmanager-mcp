...
- Вынос проверки из documentation-only `jq` в исполняемый repository script с
  fixture-тестами и CI. Это рекомендуется для предотвращения ошибок приоритета,
  но требует отдельного решения Владимира о новом поддерживаемом artefact.
