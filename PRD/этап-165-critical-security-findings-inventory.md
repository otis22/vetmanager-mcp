...
- New follow-up Roadmap stages are appended after Stage 165 as Stage 166, 167, ... in severity-then-source order: Critical/P0/sev0/blocker before High/P1/sev1/must-fix/major; threat-model T-scenarios first within the same severity. Stage 165 may be closed only after every unresolved row has an explicitly open follow-up stage and cross-reference.
