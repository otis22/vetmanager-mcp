...
SPECIAL_TOOL_DESCRIPTIONS: dict[str, str] = {
    "report_problem": (
        ...
        "capability that the result does not provide; missing tool, parameter, filter, "
        "sort, pagination, or date semantics blocks a reasonable request; a workaround "
        ...
        "<client>, <owner>, <patient>, <phone>, and <address>. Category mapping: "
        ...
        "workaround because no direct tool or parameter exists -> missing_tool; "
        "promised or implied capability not provided -> bad_description; "
        "description/docs mismatch -> bad_description; contract mismatch -> contract; "
    ...
    "confirm_report_ai_job_candidate": (
        ...
        "job.candidates. After success, the job is existing_report_matched and "
        "get_report_ai_job_data can read rows without save_report_ai_job_as_report. "
    ...
    "get_report_ai_job_data": (
        ...
        "are needed. Vetmanager caps returned rows at 10000 and limited=true means "
    ...
    "start_report_export": (
        ...
        "or time-limit states; retry only with bounded attempts. Do not log or paste export file "
