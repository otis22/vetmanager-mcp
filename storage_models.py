...
ACTIVATION_EVENT_MOTIVATOR_SHOWN = "motivator_shown"
ACTIVATION_EVENT_EXAMPLE_COPIED = "example_copied"
ACTIVATION_EVENT_NAMES = (
    ACTIVATION_EVENT_INTEGRATION_FAILED,
    ACTIVATION_EVENT_INTEGRATION_SAVED,
    ACTIVATION_EVENT_TOKEN_COPIED,
    ACTIVATION_EVENT_MOTIVATOR_SHOWN,
    ACTIVATION_EVENT_EXAMPLE_COPIED,
)
